...
router.get('/(:name)?', function(req, res, next) {
    ...
    var text = randomCompliment(data); // this line is just here to temporarily prevent an undefined error. You can remove it once you get a real compliment from the DB.
    res.render('index', {
        title: 'WDI Emergency Compliment',
        color: color,
        name: name,
